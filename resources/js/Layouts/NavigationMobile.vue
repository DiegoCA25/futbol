<template>
  ...
  <transition
    ...
    <aside v-show="$page.props.showingMobileMenu" class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-blue-900 md:hidden">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    ...
                    <span class="ml-4">Jugadores</span>
                </span>
            ...
            <ul v-show="showingTwoLevelMenu || route().current('players.index')|| route().current('players.create')" class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50"
                aria-label="submenu">
              <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                <ResponsiveNavLink :href="route('players.index')" :active="route().current('players.index')">
                  Lista
                </ResponsiveNavLink>
              </li>
              <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
